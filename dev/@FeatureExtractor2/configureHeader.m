...
% on the features extracted at each specific algorith (e.g. TC_extract.m)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
if nargin>1
    ...
    for i=1:obj.channels
        channel_headers{i}=sprintf('CH%i',i);
    end
end
...
%%%%%%%%%%% Functions for creating each extractor's header %%%%%%%%%%%%%%%%
    ...
    function header=TD_header()
        header={'rms','mean','zeroCross','slopeSignChange','waveformLength','min', 'max', 'std'};
        %header={'rms'};
    end
